...
const categoryPrompts: Record<string, string> = {
  '5分で簡単レシピ': '5分以内で作れる超時短（絶対に5分以内）',
  '材料1つでできる': 'メイン材料1つだけで作れるシンプル（5-7分）',
  '主菜（メイン）': 'ご飯が進むメインおかず（7-12分）',
  '副菜（サブ）': 'あと一品にぴったりな副菜（5-10分）',
  '汁物': '体が温まる汁物（スープ、みそ汁、鍋、ポトフ、シチューなど様々）（10-15分）',
};
...
【調理時間の厳守】
${category === '5分で簡単レシピ' 
  ? '※ 絶対に5分以内で完成する工程にしてください（最重要）' 
  : '※ 簡潔な調理時間を見積もってください（7-15分程度）'}
